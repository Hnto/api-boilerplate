...
class ApiStatusCommand extends BaseCommand
{
    ...
    protected function configure()
    {
        $this
            ->setName('status')
            ->setDescription('Shows the status of the current Api installation')
            ->setHelp('This command shows you the status of the current Api installation with all the containers, their endpoints etc.)');
    }
