...
class BaseCommand extends Command
{
    ...
    /**
     * Checks if the Api application is installed or not
     * If not, an error is returned and the command is halted
     */
    protected function checkApiExistence()
    {
        if (!file_exists(__DIR__ . '/../.env') || !file_exists(__DIR__ . '/../app/.env')) {
            $this->style->error('Api has not been installed yet');
            exit;
        }
    }
